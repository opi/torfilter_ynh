;(function(y18n){
    ...
    y18n.translateInlineHTML = function(){
      ...
      [].forEach.call(
        ...
        function(el){
          el.innerHTML = y18n.translate(el.getAttribute('data-y18n')) || el.innerHTML;
        }
      );
      ...
      [].forEach.call(
        ...
        function(el){
          el.title = y18n.translate(el.getAttribute('data-y18n-title')) || el.title;
        }
      );
    };
    ...
    y18n.translate = function(key, options) {
        ...
        return (translation) ? translation.printf(options) : false;
    };
